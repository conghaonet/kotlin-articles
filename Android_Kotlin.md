...
|     | fun sum(a: Int, b: Int): Int {    returna + b} |
| --- | --- |
...
|     | fun main(args: Array&lt;string&gt;) {    println(&quot;Args: $args&quot;)}&lt;/string&gt; |
| --- | --- |
...
|    | val name = &quot;Jake&quot;val people: List&lt;string&gt; = ArrayList()&lt;/string&gt; |
| --- | --- |
...
|       | staticbooleanisTuesday(Date date) {    returndate.getDay() == 2;} booleantuesday = DateUtils.isTuesday(date); |
| --- | --- |
...
|      | staticbooleanIsTuesday(thisDateTime date){    returndate.DayOfWeek == DayOfWeek.Tuesday;} |
| --- | --- |
...
|       | fun Date.isTuesday(): Boolean {    returngetDay() == 2} val tuesday = date.isTuesday(); |
| --- | --- |
...
|       | { x, y -&gt; x + y } val sum: (Int, Int) -&gt; Int = { x, y -&gt; x + y } val sum = { x: Int, y: Int -&gt; x + y } |
| --- | --- |
...
|        | func apply(one: Int, two: Int, func: (Int, Int) -&gt; Int): Int {    returnfunc(one, two)} val sum = apply(1, 2, { x, y -&gt; x + y })val difference = apply(1, 2, { x, y -&gt; x - y }) |
| --- | --- |
...
|    | val sum = apply(1, 2) { x, y -&gt; x + y }val difference = apply(1, 2) { x, y -&gt; x - y } |
| --- | --- |
...
|              | fun &lt;t&gt; List&lt;t&gt;.filter(predicate: (T) -&gt; Boolean): List&lt;t&gt; {    val newList = ArrayList&lt;t&gt;()    for(item inthis) {        if(predicate(item)) {            newList.add(item)        }    }    returnnewList} val names = listOf(&quot;Jake&quot;, &quot;Jesse&quot;, &quot;Matt&quot;, &quot;Alec&quot;)val jakes = names.filter { it == &quot;Jake&quot;}&lt;/t&gt;&lt;/t&gt;&lt;/t&gt;&lt;/t&gt; |
| --- | --- |
...
|       | fun Any.lock(func: () -&gt; Unit) {    synchronized (this) {        func()    }} |
| --- | --- |
...
|                | data classLock&lt;t&gt;(privateval obj: T) {    publicfun acquire(func: (T) -&gt; Unit) {        synchronized (obj) {    func(obj)        }    }} val readerLock = Lock(JsonReader(stream)) // LaterreaderLock.acquire {    println(it.readString())}&lt;/t&gt; |
| --- | --- |
...
| 1 | val notEmpty: (String) -&gt; Boolean { !it.isEmpty() } |
| --- | --- |
...
|         | db.beginTransaction();try{    db.delete(&quot;users&quot;, &quot;first\_name = ?&quot;, newString[] { &quot;Jake&quot;});    db.setTransactionSuccessful();} finally{    db.endTransaction();} |
| --- | --- |
...
|               | fun SQLiteDatabase.inTransaction(func: (SQLiteDatabase) -&gt; Unit) {    beginTransaction()    try{        func(this)        setTransactionSuccessful()    } finally{        endTransaction()    }} db.inTransaction {    it.db.delete(&quot;users&quot;, &quot;first\_name = ?&quot;, arrayOf(&quot;Jake&quot;))} |
| --- | --- |
...
|      | db.inTransaction {    it.db.delete(&quot;users&quot;, &quot;first\_name = ?&quot;, arrayOf(&quot;Jake&quot;))}&lt;font face=&quot;Tahoma, Arial, Helvetica, snas-serif&quot;&gt;&lt;span style=&quot;font-size: 14px;white-space: normal;&quot;&gt;&lt;/span&gt;&lt;/font&gt; |
| --- | --- |
...
| 1 | inline fun SQLiteDatabase.inTransaction(func: SQLiteDatabase.() -&gt; Unit) { ... } |
| --- | --- |
